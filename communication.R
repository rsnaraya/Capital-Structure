...
rm(list=ls())
dat=readxl::read_xls("D://OneDrive - Flutura Business Solutions Pvt Ltd//Personal//Paper//Logistics regression//across sectors ratios 26-Sep-2018.xls",sheet="communication")
...
for (i in missingSymbol_rownum) {
  if (datMean$Company[i] == "Himachal Futuristic Communications Ltd.") {
    datMean$Company[i] = "HFCL Ltd"
  } else if (datMean$Company[i] == "Idea Cellular Ltd.") {
    datMean$Company[i] = "Vodafone Idea Ltd"
  } else if (datMean$Company[i] == "Hathway Cable & Datacom Ltd.") {
    datMean$Company[i] = "Hathway Cable & Datacom Ltd"
